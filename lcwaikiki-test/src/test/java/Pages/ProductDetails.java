...
public class ProductDetails extends BasePage{
    ...
    public void productDetailsMethod() {
        ...
        if (dataStock.isEnabled()) {
            click(new By.ByCssSelector("a[key='1']"));

        } else if (dataStock2.isEnabled()) {
            click(new By.ByCssSelector("a[key='2']"));
        } else if (dataStock3.isEnabled()) {
            click(new By.ByCssSelector("a[key='3']"));
        }
        else if (dataStock4.isEnabled()){
            click(new By.ByCssSelector("a[key='4']"));
        }
        else{
